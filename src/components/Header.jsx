...
import movileIcon from "../images/movileIcon.png";
...
const Header = () => {
  ...
  return (
    <div className="sticky px-4 sm:px-5 flex flex-row items-center justify-between bg-[#0F0F0F] h-14 w-full z-10 top-0">
      {loading && <Loader />}
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="h-5 flex items-center">
          ...
          <img className="h-full md:hidden " src={movileIcon} />
        </Link>
      </div>
      <div className="flex group items-center">
        <div className="flex h-8 md:h-10 md:pl-5 border border-[#303030] rounded-l-3xl group focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
          ...
          <input
            type="text"
            className="bg-transparent outline-none text-white pr-5 pl-5 md:pl-o w-44 md:group-focus-within:pl-0 md:w-64 lg:w-[500]"
      ...
      <div className="flex items-center">
        <div className="hidden md:flex">
          ...
          <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
            <img
              src="https://iili.io/Jr6qLcG.md.jpg" 
              alt=""
            />
          </div>
        </div>
